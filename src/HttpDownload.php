...
namespace nguyenanhung\Libraries\HttpDownload;
    ...
    public function download()
    {
        ...
        if ($this->data_type === 0) {
            ...
            while (!connection_aborted() && $size > 0) {
                $this->bandwidth += min($size, $bufsize);
